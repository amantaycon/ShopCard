...
const UserProfileView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-bg text-brand-text flex flex-col justify-center items-center py-12 px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg glass-panel rounded-3xl overflow-hidden shadow-2xl relative border border-brand-border">
        ...
        <div className="px-8 pb-8 pt-0 relative flex flex-col items-center">
          ...
          <div className="relative -mt-16 mb-4">
            {profile?.avatarUrl ? (
              ...
              <div className="w-28 h-28 rounded-full border-4 border-brand-card shadow-lg bg-gradient-to-tr from-indigo-600 to-purple-600 flex items-center justify-center text-white text-3xl font-black uppercase">
          ...
          {error ? (
            ...
            <div className="w-full text-center space-y-4">
              <div>
                ...
                <p className="text-indigo-500 dark:text-indigo-400 text-sm font-semibold mt-0.5">
                  @{profile?.username}
                </p>
              </div>
              ...
              <div className="p-5 rounded-2xl bg-brand-bg/50 border border-brand-border/40 text-left relative">
                <span className="text-3xl text-indigo-500/20 absolute top-2 left-3 font-serif">“</span>
              ...
              <div className="flex justify-center gap-2 pt-2">
                <span className="px-3 py-1 bg-indigo-500/10 text-indigo-600 dark:text-indigo-400 text-[10px] font-bold uppercase rounded-full tracking-wider border border-indigo-500/20">
                  Verified Member
                </span>
                <span className="px-3 py-1 bg-purple-500/10 text-purple-600 dark:text-purple-400 text-[10px] font-bold uppercase rounded-full tracking-wider border border-purple-500/20">
                  ShopCard Net
                </span>
              </div>
            </div>
